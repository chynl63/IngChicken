...
export RUNTIME_ROOT="/workspace/.runtime/eval_${SLURM_JOB_ID:-$$}"
export LIBERO_CONFIG_PATH="${RUNTIME_ROOT}/libero_cfg"
export MUJOCO_GL=osmesa
export PYOPENGL_PLATFORM=osmesa
export NUMBA_CACHE_DIR="${RUNTIME_ROOT}/numba_cache"
...
"$PY" -m pip install -q --no-input "numpy<2" "h5py<3.12" bddl easydict cloudpickle gym
