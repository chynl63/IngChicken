#!/bin/bash
# Download LIBERO-Spatial demos from Hugging Face (same layout as download_libero_object.sh).
#
# Usage:
#   bash scripts/datasets/download_libero_spatial.sh
#   bash scripts/datasets/download_libero_spatial.sh /path/to/libero_spatial
set -e
...
echo "=== Downloading LIBERO-Spatial dataset from HuggingFace ==="
