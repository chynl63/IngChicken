...
# Rollout helpers live in merge/scripts/eval. Add the repository root to
# sys.path so this file can be imported either from merge/ or stand-alone.
...
from merge.scripts.eval.rollout_evaluator import (  # noqa: E402
    process_env_obs,
    obs_buffer_to_batch,
    predict_action_ddim,
