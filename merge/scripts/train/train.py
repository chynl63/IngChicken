...
Usage:
  python -m merge.scripts.train.train --config merge/configs/diffusion_policy_libero90.yaml
"""
...
from merge.datasets.libero_dataset import create_dataloader
...
def train(cfg):
    ...
    if log_cfg.get("use_tensorboard", False):
        try:
            ...
            tb_dir = Path(log_cfg.get("tensorboard_dir", ckpt_dir / "tensorboard"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="merge/configs/diffusion_policy_libero90.yaml")
